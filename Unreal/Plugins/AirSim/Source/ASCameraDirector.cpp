#include "ASCameraDirector.h"

//
#include "GameFramework/PlayerController.h"
#include "AirBlueprintLib.h"

AASCameraDirector::AASCameraDirector()
{
...
void AASCameraDirector::BeginPlay()
{
    Super::BeginPlay();
}

void AASCameraDirector::Tick(float DeltaTime)
{
...
ECameraDirectorMode AASCameraDirector::getMode()
{
    return mode_;
}

void AASCameraDirector::initializeForBeginPlay(ECameraDirectorMode view_mode,
...
void AASCameraDirector::attachSpringArm(bool attach)
{
    if (attach) {
...
void AASCameraDirector::setMode(ECameraDirectorMode mode)
{
...
void AASCameraDirector::setupInputBindings()
{
    UAirBlueprintLib::EnableInput(this);

    UAirBlueprintLib::BindActionToKey("inputEventFpvView", EKeys::F, this, &AASCameraDirector::inputEventFpvView);
    UAirBlueprintLib::BindActionToKey("inputEventFlyWithView", EKeys::B, this, &AASCameraDirector::inputEventFlyWithView);
    UAirBlueprintLib::BindActionToKey("inputEventGroundView", EKeys::Backslash, this, &AASCameraDirector::inputEventGroundView);
    UAirBlueprintLib::BindActionToKey("inputEventManualView", EKeys::M, this, &AASCameraDirector::inputEventManualView);
    UAirBlueprintLib::BindActionToKey("inputEventSpringArmChaseView", EKeys::Slash, this, &AASCameraDirector::inputEventSpringArmChaseView);
    UAirBlueprintLib::BindActionToKey("inputEventBackupView", EKeys::K, this, &AASCameraDirector::inputEventBackupView);
    UAirBlueprintLib::BindActionToKey("inputEventNoDisplayView", EKeys::Hyphen, this, &AASCameraDirector::inputEventNoDisplayView);
    UAirBlueprintLib::BindActionToKey("inputEventFrontView", EKeys::I, this, &AASCameraDirector::inputEventFrontView);
}

void AASCameraDirector::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
APIPCamera* AASCameraDirector::getFpvCamera() const
{
    return fpv_camera_;
}

APIPCamera* AASCameraDirector::getExternalCamera() const
{
    return ExternalCamera;
}

APIPCamera* AASCameraDirector::getBackupCamera() const
{
    return backup_camera_;
}

void AASCameraDirector::inputEventSpringArmChaseView()
{
    if (ExternalCamera) {
...
void AASCameraDirector::inputEventGroundView()
{
    if (ExternalCamera) {
...
void AASCameraDirector::inputEventManualView()
{
    if (ExternalCamera) {
...
void AASCameraDirector::inputEventNoDisplayView()
{
    if (ExternalCamera) {
...
void AASCameraDirector::inputEventBackupView()
{
    if (backup_camera_) {
...
void AASCameraDirector::inputEventFrontView()
{
    if (front_camera_) {
...
void AASCameraDirector::inputEventFlyWithView()
{
    if (ExternalCamera) {
...
void AASCameraDirector::inputEventFpvView()
{
    if (fpv_camera_) {
...
void AASCameraDirector::disableCameras(bool fpv, bool backup, bool external, bool front)
{
    if (fpv && fpv_camera_)
...
void AASCameraDirector::notifyViewModeChanged()
{
